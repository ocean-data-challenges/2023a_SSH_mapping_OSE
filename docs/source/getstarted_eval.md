...
Note that some formatting can be done using xarray within the jupyter notebooks. For instance, you can change a variable's name simpy with `ds = ds.rename_var({'my_sla':'sla'})`. 
